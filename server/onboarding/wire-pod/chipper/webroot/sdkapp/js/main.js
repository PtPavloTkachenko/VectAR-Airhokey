...
function showSection(id) {
  ...
  if (id == "section-cube") {
    ...
    if (typeof cubeStreamRunning !== 'undefined' && cubeStreamRunning) stopCubeSection();
  }
  if (id == "section-sensors") {
    startSensorSection();
  } else {
    if (typeof sensorStreamRunning !== 'undefined' && sensorStreamRunning) stopSensorSection();
  }
}
